...
--
-- Host: 127.0.0.1
-- Generation Time: May 15, 2024 at 09:26 AM
...
(18, 'Max', '66445b7cf130d.jpg', 'Khursanitar, baluwatar', 'Introducing Max, the ultimate German Shepherd whose charm knows no bounds. With a coat as sleek as midnight and eyes that gleam with intelligence, Max is the epitome of canine greatness. His loyalty knows no limits, and his love for his family is unwavering.\r\n\r\nMax is not  just a dog, he is  a cherished member of the family, a protector, and a source of endless joy. Whether he is bounding through fields with grace or curling up at your feet with a contented sigh, Maxs presence brings warmth and comfort to all who know him. In Max, you will find not just a pet, but a true companion who enriches every moment with his boundless affection and unwavering devotion.', '20', '3', 'Yes', 'Dog', 1, 3);
...
INSERT INTO `pet_adoptions` (`id`, `adopt_date`, `user_id_fk`, `animal_id_fk`, `request_date`, `living_condition`, `previous_experience`, `adoption_reason`, `shelter_id`) VALUES
(1, '2023-07-29', 2, 2, '2023-07-29', 'dummy living condition text', 'dummy previous expeirence text', 'dummy reason text', 0),
(2, '2023-07-29', 2, 2, '2023-07-29', 'dummy living condition text', 'dummy previous expeirence text', 'dummy reason text', 0),
(3, '2023-07-29', 2, 2, '2023-07-29', 'dummy living condition text', 'dummy previous expeirence text', 'dummy reason text', 0),
(4, '2023-07-29', 2, 2, '2023-07-29', 'dummy living condition text', 'dummy previous expeirence text', 'dummy reason text', 0),
(5, '2023-07-29', 2, 2, '2023-07-29', 'dummy living condition text', 'dummy previous expeirence text', 'dummy reason text', 0),
(6, '0000-00-00', 2, 5, '2023-07-29', 'dummy living condition text', 'dummy previous expeirence text', 'dummy reason text', 0),
(7, '2023-07-29', 2, 3, '2023-07-29', 'dummy living condition text', 'dummy previous expeirence text', 'dummy reason text', 0),
(8, '2023-07-29', 2, 3, '2023-07-29', 'dummy living condition text', 'dummy previous expeirence text', 'dummy reason text', 0),
(9, '0000-00-00', 2, 4, '2023-07-29', 'dummy living condition text', 'dummy previous expeirence text', 'dummy reason text', 0),
(10, '2023-07-29', 2, 2, '2023-07-29', 'dummy living condition text', 'dummy previous expeirence text', 'dummy reason text', 0),
(11, '2023-07-29', 2, 1, '2023-07-29', 'dummy living condition text', 'dummy previous expeirence text', 'dummy reason text', 0),
(12, '2023-07-29', 2, 10, '2023-07-29', 'dummy living condition text', 'dummy previous expeirence text', 'dummy reason text', 0),
(16, '0000-00-00', 4, 1, '2023-08-17', 'I have a big house', 'I had a lot of experience', 'My wife wants a cat', 0),
(17, NULL, 4, 1, '2023-08-17', 'great conditions i have', 'many experiences. i killed my all cats', 'i want to eat', 0),
(18, '0000-00-00', 4, 5, '2023-08-17', 'great place to live', 'no dog experience', 'my doctor said is good for anxiety', 0),
(19, NULL, 4, 5, '2023-08-17', 'I said thousand times, my house is big', 'no experience, i lied before', 'i want this dog', 0),
(20, NULL, 4, 5, '2023-08-17', 'last try. great house for this dog', 'no experience', 'i want it', 0),
(21, NULL, 6, 7, '2024-05-15', 'A vast open space for dog to play around and enjoy his life', 'Owned 2 Dogs before', 'I need a great companion and guard dog for my home.', 4);
